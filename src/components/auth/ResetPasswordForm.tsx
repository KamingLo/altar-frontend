  ...
  return (
    <div className="h-[100svh] w-full overflow-hidden flex justify-center bg-[#EDF2F4] font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <div className="relative w-full max-w-[450px] h-[100svh] bg-[#EDF2F4] flex flex-col overflow-hidden mx-auto shadow-[0_0_40px_rgba(0,0,0,0.05)]">
        ...
        <div className={`absolute left-6 right-6 top-8 z-50 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${showErrorToast ? 'translate-y-0 opacity-100' : '-translate-y-12 opacity-0 pointer-events-none'}`}>
          {message?.type === 'error' && (
        ...
        <div className={`absolute left-6 right-6 top-8 z-50 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${showSuccessToast ? 'translate-y-0 opacity-100' : '-translate-y-12 opacity-0 pointer-events-none'}`}>
