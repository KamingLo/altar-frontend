...
export function ResetPasswordForm() {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex h-screen w-full overflow-hidden items-center bg-canvas font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <div className="flex lg:hidden h-[100svh] w-full overflow-hidden justify-center bg-canvas font-['Plus_Jakarta_Sans',sans-serif]">
        <div className="relative w-full max-w-[450px] md:max-w-[650px] h-[100svh] bg-canvas flex flex-col overflow-hidden mx-auto shadow-[0_0_40px_rgba(0,0,0,0.05)]">
